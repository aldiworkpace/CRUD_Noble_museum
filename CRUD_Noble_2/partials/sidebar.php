...
<style>
    ...
    .bottom-accent-card {
        background-image: url('assets/image/chaldea.gif');
        border-radius: 16px;
        padding: 18px;
        color: #1c1c24;
        text-align: left;
...
<nav class="navbar d-md-none px-3 sticky-top" style="background-color: #000000;">
...
<div class="offcanvas-md offcanvas-start sidebar-modern" tabindex="-1" id="sidebarMenu" style="width: 260px; min-height: 100vh; position: fixed; top: 0; left: 0; z-index: 1055;">
    ...
    <div class="d-flex flex-column vh-100 p-3">
        <a href="data.php" class="d-none d-md-flex align-items-center mb-4 text-decoration-none">
            <i class="bi bi-database-add fs-3 me-2" style="color: #ffffff;"></i>
            <span class="fs-4 sidebar-header-text">Welcome Bos</span>
        </a>

        <div class="profil-container">
            <img src="assets/image/profile.jpg" alt="Foto Profil" class="profil-foto">
        ...
        <ul class="nav nav-modern flex-column gap-2">
            <li class="nav-item">
                <a href="index.php" class="nav-link <?= strpos($current_url, 'index.php') !== false ? 'active' : '' ?>">
                    <i class="bi bi-grid-1x2-fill me-3"></i>Dashboard
                </a>
            </li>

            <li class="nav-item">
                <a href="data.php" class="nav-link <?= (strpos($current_url, 'data.php') !== false || strpos($current_url, 'dashboard.php') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-hdd-stack-fill me-3"></i>Data Museum
                </a>
            </li>

            <li class="nav-item">
                <a href="tambah.php" class="nav-link <?= strpos($current_url, 'tambah.php') !== false ? 'active' : '' ?>">
                    <i class="bi bi-plus-square-fill me-3"></i>Tambah Data
                </a>
            </li>
            <li class="nav-item">
                <a href="user.php" class="nav-link <?= strpos($current_url, 'user.php') !== false ? 'active' : '' ?>">
        ...
        <div class="mt-auto pt-3">
            ...
            <a href="login/logout.php" class="nav-link text-danger d-flex align-items-center rounded p-2" style="transition: 0.3s;" onmouseover="this.style.backgroundColor='rgba(220, 53, 69, 0.1)'" onmouseout="this.style.backgroundColor='transparent'" onclick="return confirm('Apakah Anda yakin ingin keluar?');">
