<?php
include 'data/partials/header.php';
include 'data/partials/sidebar.php';
include 'koneksi.php';
...
<div class="main-content" style="padding: 30px 20px; min-height: 100vh; background-color: #F8F9FA">

    <div class="header-senjata d-flex justify-content-between align-items-center mb-4">

        <div>
            <h3 class="fw-bold text-dark mb-1">Welcome Bos</h3>
            <span class="text-muted">Data Museum Senjata Mitologi</span>
        </div>

        <div>
            <img src="/CRUD_Noble/data/assets/image/pokemon.gif" alt="Ilustrasi" class="gambar-header shadow-sm">
        </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card kartu-senjata h-100">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <a href="data/partials/detail.php?id=<?php echo $row['id_senjata']; ?>" class="detail-tombol w-100 text-center text-decoration-none mt-auto">Lihat Detail</a>
                    </div>
                </div>
            </div>
        <?php } ?>
