...
<div class="main-content" style="padding: 30px 20px; min-height: 100vh; background-color: #ECEBE6;">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="data/proses/report.php" target="_blank" class="btn btn-danger fw-bold tombol-bulat d-flex align-items-center">
                <i class="bi bi-file-earmark-pdf me-2 fs-5"></i> Cetak PDF
            </a>
            <a href="data/proses/tambah.php" class="btn fw-bold tombol-bulat d-flex align-items-center" style="background-color: #d4f55a; color: #000000;">
