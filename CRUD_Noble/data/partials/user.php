...
<div class="main-content" style="padding: 30px 20px; min-height: 100vh; background-color: #f4f6f9;">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h3 class="fw-bold mb-0 text-dark">Data User</h3>
            <span class="text-muted" style="font-size: 0.9rem;">Manajemen Admin</span>
        </div>

        <div>
            <a href="../user/create.php" class="btn fw-bold" style="background-color: #d4f55a; color: #1c1c24; border-radius: 12px; padding: 10px 20px;">
